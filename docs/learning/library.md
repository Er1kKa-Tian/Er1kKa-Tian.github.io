...
- (book: economics) Pilkington, P. (2016) **The Reformation in Economics: A Deconstruction and Reconstruction of Economic Theory**
...
- (course: economics) Oxford Mphil Economics: Core Microecoomics
- (course: economics) Oxford Mphil Economics: Core Macroeconomics
- (course: economics) Oxford Mphil Economics: Core Econometrics
...
- (course: maths) Oxford Mphil Economics: Prep Maths and Mathematical Methods(fn:202406)
...
- (course: cs) Harvard CS50P
- (course: cs) Harvard CS50X
- (course: maths) MIT 18.06 Linear Algebra
- (course: cs) MIT The Missing Semester of Your CS Education